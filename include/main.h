...
#define ALARM_BUTTON				GPIO_PIN_9  	/* GPIOC->IDR & GPIO_PIN_9 */
#define MODE_BUTTON					GPIO_PIN_8  	/* GPIOC->IDR & GPIO_PIN_8 */
#define	ON_OFF_BUTTON				GPIO_PIN_5  	/* GPIOC->IDR & GPIO_PIN_5 */
#define TIME_BUTTON					GPIO_PIN_4  	/* GPIOC->IDR & GPIO_PIN_4 */
...
#define ALL_BUTTONS					( SNOOZE_BUTTON | ALARM_BUTTON | MODE_BUTTON | ON_OFF_BUTTON | TIME_BUTTON )
